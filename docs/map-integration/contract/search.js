...
var MC = (function () {
    ...
    function MC() {
        ...
        this.map = new Map();
        this.map.init(document.getElementById('map'), this, {
            center: [12.58, 55.67],
            zoomLevel: 13
        })
    }
    ...
    MC.prototype.refresh = function () {
        ...
        //        var coordinates = _this.getCoordinateFromGeohash(bucket.key);
        //        assets.push({
        ...
        //}
        //xhr.send(JSON.stringify({ "query": { "boosting": { "positive": { "bool": { "must": [{ "bool": { "must_not": { "term": { "related.assets.direction": "parent" } } } }, { "bool": { "should": [{ "bool": { "should": [{ "exists": { "field": "google_maps_coordinates" } }, { "exists": { "field": "google_maps_coordinates_crowd" } }] } }] } }, { "geo_bounding_box": { "location": { "top_left": { "lat": 55.72572422597386, "lon": 12.442300549316428 }, "bottom_right": { "lat": 55.642304025872946, "lon": 12.727773419189475 } } } }] } }, "negative": { "query_string": { "default_operator": "OR", "default_field": "tags_vision", "query": "" } }, "negative_boost": 0.5 } }, "sort": "_score", "aggregations": { "geohash_grid": { "geohash_grid": { "field": "location", "precision": 6 } } } }));
